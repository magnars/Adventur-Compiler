...
class CondTree
  ...
  def self.some_regexp()
    /^enten (?:(?:[0-9]+|(?:\$|\]C\[|[nk]r)?[A-ZÆØÅ0-9:.*_-]+)(?: (?:[+*\/<>-]|<=|>=|==) (?:[0-9]+|(?:\$|\]C\[|[nk]r)?[A-ZÆØÅ0-9:.*_-]+))*(?:, )?)+ eller (?:[0-9]+|(?:\$|\]C\[|[nk]r)?[A-ZÆØÅ0-9:.*_-]+)(?: (?:[+*\/<>-]|<=|>=|==) (?:[0-9]+|(?:\$|\]C\[|[nk]r)?[A-ZÆØÅ0-9:.*_-]+))*/
  end
  ...
  def self.all_regexp()
    /^både (?:(?:[0-9]+|(?:\$|\]C\[|[nk]r)?[A-ZÆØÅ0-9:.*_-]+)(?: (?:[+*\/<>-]|<=|>=|==) (?:[0-9]+|(?:\$|\]C\[|[nk]r)?[A-ZÆØÅ0-9:.*_-]+))*(?:, )?)+ og (?:[0-9]+|(?:\$|\]C\[|[nk]r)?[A-ZÆØÅ0-9:.*_-]+)(?: (?:[+*\/<>-]|<=|>=|==) (?:[0-9]+|(?:\$|\]C\[|[nk]r)?[A-ZÆØÅ0-9:.*_-]+))*/
  end
  ...
  def self.value_regexp()
    /^(?:[0-9]+|(?:\$|\]C\[|[nk]r)?[A-ZÆØÅ0-9:.*_-]+)(?: (?:[+*\/<>-]|<=|>=|==) (?:[0-9]+|(?:\$|\]C\[|[nk]r)?[A-ZÆØÅ0-9:.*_-]+))* [!<>=]=? (?:[0-9]+|(?:\$|\]C\[|[nk]r)?[A-ZÆØÅ0-9:.*_-]+)(?: (?:[+*\/<>-]|<=|>=|==) (?:[0-9]+|(?:\$|\]C\[|[nk]r)?[A-ZÆØÅ0-9:.*_-]+))*/
  end
